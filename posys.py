...
#                    [14, 1.000, 0.0, 0.0,   0.000, 0.149,  0.050, 0.0, 0.0, 3]])
    ...
    # -- true solution
    bus = np.array([[1,  1.060,   0.00, 2.324,-0.169, 0.000,  0.000, 0.0, 0.0, 
                     1],
                    [2,  1.045,  -4.98, 0.4,   0.424, 0.217,  0.127, 0.0, 0.0, 
                     2],
                    [3,  1.010, -12.72, 0.0,   0.234, 0.942,  0.190, 0.0, 0.0, 
                     2],
                    [4,  1.019, -10.33, 0.0,   0.000, 0.478, -0.039, 0.0, 0.0, 
                     3],
                    [5,  1.020,  -8.78, 0.0,   0.000, 0.076,  0.016, 0.0, 0.0, 
                     3],
                    [6,  1.070, -14.22, 0.0,   0.122, 0.112,  0.075, 0.0, 0.0, 
                     2],
                    [7,  1.062, -13.37, 0.0,   0.000, 0.000,  0.000, 0.0, 0.0, 
                     3],
                    [8,  1.090, -13.36, 0.0,   0.174, 0.000,  0.000, 0.0, 0.0, 
                     2],
                    [9,  1.056, -14.94, 0.0,   0.000, 0.295,  0.166, 0.0, 0.0, 
                     3],
                    [10, 1.051, -15.10, 0.0,   0.000, 0.090,  0.058, 0.0, 0.0, 
                     3],
                    [11, 1.057, -14.79, 0.0,   0.000, 0.035,  0.018, 0.0, 0.0, 
                     3],
                    [12, 1.055, -15.07, 0.0,   0.000, 0.061,  0.016, 0.0, 0.0, 
                     3],
                    [13, 1.050, -15.16, 0.0,   0.000, 0.135,  0.058, 0.0, 0.0, 
                     3],
                    [14, 1.036, -16.04, 0.0,   0.000, 0.149,  0.050, 0.0, 0.0, 
                     3]])
